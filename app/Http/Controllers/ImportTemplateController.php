...
class ImportTemplateController extends Controller
{
    ...
    private const HEADERS = [
        'IMEI', 'Model', 'Product Code', 'TSO', 'RD Code', 'RD Name', 'RTCode', 'RT Name', 'ST Date', 'Activation', 'SELL-IN', 'Source',
    ];

    private const SAMPLE_ROWS = [
        ['863222207290410', 'C63 (8+128GB)', 'RMX3830', 'Roshan Singh', 'MDDX2803', 'BRAHMA DIGITAL PVT LTD', 'NP057002', 'Ashish electronics & mobile', '2025-03-03', '2026-07-08', '2025-02-20', 'Manual'],
        ['863222072207893', 'C63 (8+128GB)', 'RMX3830', 'Roshan Singh', 'MD001061', 'New Rameshworam Suppliers', 'NP065585', 'New dipesh mobile gallery', '2025-03-02', '', '2025-02-18', 'Manual'],
    ];
    ...
    private const SELL_THROUGH_HEADERS = ['IMEI', 'RD Code', 'RTCode', 'ST Date'];

    /* Placeholder rows — replace with your data. Only IMEI, RTCode and ST Date
       are used on import; RD Code is informational. */
    private const SELL_THROUGH_ROWS = [
        ['<15-digit IMEI>', '<RD code>', '<RT code>', '2026-09-01'],
        ['<15-digit IMEI>', '<RD code>', '<RT code>', '2026-09-01'],
    ];
