...
return [
    ...
    */
    'anti_mock' => [
        ...
        'historical_repetition_threshold_metres' => (float) env('ATTENDANCE_REPEAT_THRESHOLD_METRES', 1.5),
        ...
        'checkout_repetition_threshold_metres' => (float) env('ATTENDANCE_CHECKOUT_REPEAT_THRESHOLD_METRES', 1.0),

        // Cross-user collision threshold on same date (in metres) to prevent shared mock pins.
        'cross_user_collision_metres' => (float) env('ATTENDANCE_CROSS_USER_COLLISION_METRES', 1.0),
    ],
];
