...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Import files can be large. Cap here is in KB (512 MB); the real ceiling
        // is PHP's upload_max_filesize / post_max_size and the web server's body
        // limit — raise those in production, or use `php artisan records:import`
        // for multi-GB / millions-of-rows loads.
        'rules' => ['required', 'file', 'max:'.env('IMPORT_MAX_UPLOAD_KB', 524288)],
